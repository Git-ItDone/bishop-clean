...
The repository includes a 54-test suite that covers safety, approval behavior, file boundaries, shell limits, audit records, registry behavior, model-response parsing, and multi-turn agent execution. GitHub Actions runs the suite on every push and pull request.
